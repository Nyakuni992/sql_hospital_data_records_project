...
It consists of dimension tables and fact tables structured to measure and analyze key medical and business metrics.
---

### 1. **gold.dim_patients**
- **Purpose:** Stores patient's details including demographic and geographic data.
- **Columns:**
...
| Marital_status   | NVARCHAR(50)      | The marital status of the patient (e.g., 'Married', 'Single', 'n/a').                                                                           |
